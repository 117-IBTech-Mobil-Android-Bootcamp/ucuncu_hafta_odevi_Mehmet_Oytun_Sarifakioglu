package com.oytuns.ucuncu_hafta_odevi_mehmet_oytun_sarifakioglu.adapter
...
class Adapter(val dataList:ArrayList<Data>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
